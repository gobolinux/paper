...
\documentclass[english,times,10pt]{sigplanconf}
\usepackage{mathptmx}
...
\authorinfo{Hisham Muhammad}{PUC-Rio - Rio de Janeiro, Brazil}{hisham.hm@gmail.com}{}


\authorinfo{Lucas C. Villa Real}{IBM Research - Sao Paulo, Brazil}{lucasvr@br.ibm.com}{}


\authorinfo{Michael Homer}{Victoria University of Wellington - Wellington, New Zealand}{mwh@ecs.vuw.ac.nz}{}


\conferenceinfo{Onward! 2016}{}
...
of similar managers. In this paper, we share our experience from over
a decade of writing package managers for both a Linux distribution
and a scripting language, and draw on that experience to categorize
families of package managers and discuss their design implications
beyond particular implementations. We also identify possibilities
in the still largely unexplored area of package manager interoperability.
...
were created to solve practical problems which the developer would
...
for a Linux distribution \cite{Muhammad2002WSL,Homer2010LCA}, creating
a language-specific package manager \cite{Muhammad2013LuaRocks},
and integrating system and language-specific package managers \cite{Homer2010LCA},
as well as being simply developers and end users of other software.
We will present these experiences and propose categorizations and
commonalities we have found in them, and aim to show that — as all
of the observations about languages above can be made equally about
package management — package management can and should follow the
lead of programming languages in the solution space as well.
...
\includegraphics[scale=0.8,bb = 0 0 200 100, draft, type=eps]{/Users/hisham/ac/gobo/python_pip.eps} & \includegraphics[scale=0.8,bb = 0 0 200 100, draft, type=eps]{/Users/hisham/ac/gobo/ruby_rubygems.eps}\tabularnewline
...
\includegraphics[scale=0.8,bb = 0 0 200 100, draft, type=eps]{/Users/hisham/ac/gobo/gobo_systemindex.eps} & \includegraphics[scale=0.8,bb = 0 0 200 100, draft, type=eps]{/Users/hisham/ac/gobo/gobo_programs.eps}\tabularnewline
(a) The filesystem is indexed with the use of \\
directories and symbolic links. & \multirow{1}{0.5\paperwidth}{(b) Versioned directory tree.}\tabularnewline
...
of which lack a built-in universal package manager (Microsoft Windows
...
As also happened with GoboLinux, having a high-level description format
allowed us to make radical changes to the installation layout once
that proved necessary. Since LuaRocks does not provide to specification
...
and maintenance over the years of a system-wide package manager for
a Linux distribution and a portable package manager for a scripting
language, and an analysis of the landscape of existing methodologies
for package management. Package management is an area that is notably
neglected in academic studies, but is one of practical impact in the
design of modern operating systems and module systems for programming
languages, and a central issue in system administration. With this
work, we provide the beginnings of a conceptual organization of approaches
for package management, an area that lacks even common terminology,
and where many of the same design issues are faced and dealt with
time and again.
