...
\section{Background: package management}




\section{Experiences in package management}
...
ecosystem of the Lua programming language. It was developed building
on our previous experience writing package management tools for GoboLinux
and adapting them to the realities of a language-specific manager.
...
\subsection{Paradigms of package management: filesystem-oriented vs. database-oriented}
...
package managers, such as npm and Bower, but as we discussed in Section
...
\subsection{Language-specific vs. language-agnostic package managers}
...
\subsection{Integration between languages vs. integration between package managers}
