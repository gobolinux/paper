...
\includegraphics[scale=0.6,bb = 0 0 200 100, draft, type=eps]{C:/Users/hisham/projects/gobolinux/paper/gobo_systemindex.eps}\tabularnewline
(a) The filesystem is indexed with the use of \\
directories and symbolic links.\\
\\
\tabularnewline
\includegraphics[scale=0.6,bb = 0 0 200 100, draft, type=eps]{C:/Users/hisham/projects/gobolinux/paper/gobo_programs.eps}\tabularnewline
...
files (rockspecs) any knowledge of the final directory structure.
This allowed all existing rockspecs to be used in the new directory
