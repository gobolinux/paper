...
\begin{tabular}{|c|c|c|}
\cline{2-3} 
\multicolumn{1}{c|}{} & Filesystem-oriented & Database-oriented\tabularnewline
\hline 
Language-agnostic & %
...
\protect\caption{A package manager taxonomy}
\end{figure}
...
\end{itemize}
\item Short history of alternative approaches: Zero Install (still active),
Autopackage (dormant, ``packages must be relocatable''), 
\item Being database-oriented does not imply an opaque, binary database
